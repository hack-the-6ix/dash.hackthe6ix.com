  ...
  return (
    <>
      ...
      <Typography textColor='neutral-50' textType='heading6' as='p' className={styles.teamFormationDescription}>
        Don't have a team? No worries! You can create your own team and invite your friends, join a team, or decide to go solo. You can change this at any point before applications close. </span>
      </Typography>
